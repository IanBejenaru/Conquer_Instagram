...
#Para poder utilizar los archivos multimedia:
from django.conf import settings
from django.conf.urls.static import static
from post.views import PostCreateView, PostDetailView, like_post, like_post_ajax

#Creamos las rutas url para cargar las vistas que hemos creado:
urlpatterns = [
    ...
    #El profile va a necesitar de un pk para poder verse:
